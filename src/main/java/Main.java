  ...
  public static void main(final String[] args) throws InterruptedException {
    ...
    do {
      ...
      do {
        ...
        // TODO check for winner, if winner Main.rematch() and game == false to quit game

        ui.changePlayer(); // alternate turn and player mark
      } while (game == true);
      game = true; // makes inside do-while loop loop again for rematch
      ui.createBoard(); // creates new board
    } while (rematch == true);
  }
